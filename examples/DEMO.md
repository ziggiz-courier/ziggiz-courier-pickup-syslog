...
3. Any processing actions taken

For example, when sending an RFC 5424 message, you might see output like:

```
2023-05-22 11:45:23 DEBUG ziggiz_courier_pickup_syslog.protocol.udp Received 198 bytes from ('127.0.0.1', 54321)
2023-05-22 11:45:23 DEBUG ziggiz_courier_pickup_syslog.protocol.decoder.rfc5424 Parsed RFC5424 message: {
  'priority': 165,
  'facility': 20,
  'severity': 5,
  'version': 1,
  'timestamp': '2023-05-22T11:45:23.000Z',
  'hostname': 'macbook-pro',
  'appname': 'ziggiz-courier',
  'procid': '12345',
  'msgid': 'PICKUP1684756523',
  'structured_data': {
    'exampleSDID@32473': {'iut': '3'},
    'ziggiz@32473': {'event': 'pickup', 'trackingId': 'PKG1684756523'}
  },
  'message': 'Courier package pickup notification generated at 2023-05-22 11:45:23'
}
```
